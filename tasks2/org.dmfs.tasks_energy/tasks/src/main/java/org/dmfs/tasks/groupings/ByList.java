	...
	public final ViewDescriptor TASK_VIEW_DESCRIPTOR = new ViewDescriptor()
	{
		...
		public void populateView(View view, Cursor cursor, BaseExpandableListAdapter adapter, int flags)
		{
			...
			if (divider != null)
			{
                ...
                //divider.setBackground(new ColorDrawable(Color.parseColor("#18531F")));
			}
            ...
            title.setTextColor(Color.parseColor("#18531F"));
		}
		...
		public void populateView(View view, Cursor cursor, BaseExpandableListAdapter adapter, int flags)
		{
			...
			if ((flags & FLAG_IS_EXPANDED) != 0)
			{
				if (colorbar1 != null)
				{
					...
					colorbar1.setBackgroundColor(Color.parseColor("#59865F"));
